...
MIMM_set_path
determ = load('MIMM_dictionary_deterministic.mat');
dict = determ.dictionary;
lambda_chi = 0.015;
load('FA.mat')
load('QSM.mat')
load('theta.mat')
...
save('Example_Results/deterministic_MIMM_results_new.mat', 'MIMM_basic', 'MIMM_DTI', 'MIMM_Atlas')
disp('All done!')
